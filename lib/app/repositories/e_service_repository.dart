...
class EServiceRepository {
  ...
  Future<List<Review>> getReviews(String eServiceId,VideoPlayerController videoPlayerController) {
    return _laravelApiClient.getEServiceReviews(eServiceId);
  }

  Future<List<OptionGroup>> getOptionGroups(String eServiceId,VideoPlayerController videoPlayerController) {
