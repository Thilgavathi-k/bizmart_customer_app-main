...
class KycDetailsEdit {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  KycDetailsDadtaEdit(sid,Pan, driving, passport_file, liquir, trade, llp, company,documnet,Fssai) async {
    ...
    try {
      ...
      Response response = await dio.post(mainUrl + "/api/contract_kyc",
        data: formData,
        options: Options(
          method: 'POST',
