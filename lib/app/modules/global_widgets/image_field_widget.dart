...
class ImageFieldController extends GetxController {
  ...
  Future pickImage(ImageSource source, String field, ValueChanged<String> uploadCompleted)
  async {
          ...
          if (initialImage != null && image == null)
            ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => Icon(Icons.image_outlined,color: Colors.grey.shade300,size: 30,),
              ),
            ),
          if (image != null)
            ClipRRect(
