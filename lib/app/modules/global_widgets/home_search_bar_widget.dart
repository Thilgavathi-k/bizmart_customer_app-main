  ...
  Widget buildSearchBar() {
    ...
    return Hero(
      ...
      child:  GestureDetector(
        ...
        async {
            Get.back();
            Get.find<SearchController>().textEditingController.clear();
            Get.find<SearchController>().eServices.clear();
        ...
        child: Padding(
          ...
          child: Container(
            height: 25,width: 25,
              child: Image.asset('assets/img/search.png',height: 25,width: 25,)),
        ),
      ),
      // child: Container(
